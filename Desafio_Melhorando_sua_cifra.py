...
alfabeto = "zacbdfegihjkmnloqprstvuwyx"
...
while True:
    ...
    if resposta == 'S':
        ...
        if variavel == 1:
            ...
            mensagem = input("Por favor, entre com a mensagem a ser criptografada: ").lower().split()
            

        elif variavel == 2:
            #capture a mensagem do usuário
            mensagem = input("Por favor, entre com a mensagem a ser descriptografada: ").lower().split()
